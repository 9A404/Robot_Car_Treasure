...
const u8 runMethodTable[][100]={
	/* 调试路线 */
/*0*/{25,28,50,30,31,32,31,15,14,35,36,35,14,6,5,2,1,2},
...
///*5*/{1,2,3,4,3,5,10,11,10,12,7,6,42,14,44,43,17,18,19,18,17,43,16,44,45,46,47,46,43,44,37,36,15,30,31,32,31,33,23,24,23,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},
	/*5*/{1,2,3,4,3,5,12,7,6,15,37,14,16,44,45,46,47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,30,31,32,31,15,14,35,36,35,6,5,2,1,2},	
...
/*6*/{1,2,3,4,3,5,12,10,11,10,9,5,6,8,6,7,6,15,37,14,16,44,45,46,47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,30,31,32,31,15,9,5,2,1,2},//少06景点
		
		/*切换路线，用于路段调试*/
	/*0号切换路线,第1个宝物所在位置在7，并且第2个宝物所在位置为37所切换的路线 */
	{7,6,15,37,15,9,5,2,1,2},
...
const u8 runMethodTableTreasure[][100]={
	...
	/*1号切换路线,第1个宝物所在位置在12，并且第2个宝物所在位置为37所切换的路线 */
	//{12,7,6,42,14,37,36,15,39,9,5,2,1,2},
	{12,7,6,15,37,15,9,5,2,1,2},
	/*2号切换路线, 第2个宝物所在位置在37，并且第3个宝物位置在24所切换的路线*/
	//{37,36,15,30,31,32,31,33,23,24,23,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},
	{37,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,30,31,32,31,9,5,2,1,2},
	/*3号切换路线, 第2个宝物所在位置在37，并且第3个宝物位置在27所切换的路线*/
	//{37,36,15,30,31,32,31,33,23,24,23,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},
	{37,15,31,32,31,30,50,28,25,26,27,26,25,23,24,23,22,21,20,18,19,18,17,14,6,5,2,1,2},
	/*4号切换路线, 第2个宝物所在位置在47，并且第3个宝物位置在24所切换的路线*/
