...
const u8 runMethodTable[][100]={
	/* 调试路线 */
/*0*/{14,35,36,35,34,30,31,32,31,9,5,2,1,2},
...
const u8 runMethodTableTreasure[][100]={
	...
	/*5号切换路线, 第2个宝物所在位置在47，并且第3个宝物位置在27所切换的路线*/
	//{47,46,43,44,37,36,15,30,31,32,31,33,23,24,23,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},
	{47,46,48,43,16,17,18,19,18,20,21,22,23,25,26,27,26,25,23,24,23,22,21,20,17,14,6,5,2,1,2},
};
