...
/*全局变量*/
const u16  basic_sensorThreshold[NUM_OF_SENSOR] = {2800,3800,3800,3800,3800,3800,3800,3800,3800,3800,3800,3800};
const u16  brige_sensorThreshold[NUM_OF_SENSOR] = {1850,800,800,800,800,800,800,800,800,800,800,800};
...
/*0*/{ 14,16,44,45,46,47,46,48,43,16,44,14,6},
...
/*3*/{1,2,3,4,3,5,12,7,6,15,37,14, 16,44,45,46,47,46,48,43,16,44,14,6,5,2,1,2},  
	...
	/*拿3个宝物加一个梯形 已修改*/                                       
/*4*/{1,2,3,4,3,5,12,7,6,15,37,14,16,44,45,46,47,46,48, 43,  16,17,18,19,18,20,21,22,23,24,23,25,26,27,26, 25,23,22,21,20,18,17,14,6,5,2,1,2},
...
/*6*/{1,2,3,4,3,5,10,11,10,12,6,8,6,7,6,42,14,44,43,17,18,19,18,17,43,16,44,45,46,47,46,43,44,37,36,15,30,31,32,31,33,23,24,23,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},		
	...
	{7,6,42,14,37,36,15,39,9,5,2,1,2},
	
	/*1号切换路线,第1个宝物所在位置在12，并且第2个宝物所在位置为37所切换的路线 */
	{12,7,6,42,14,37,36,15,39,9,5,2,1,2},
	
	/*2号切换路线, 第2个宝物所在位置在37，并且第3个宝物位置在24所切换的路线*/
	{37,36,15,30,31,32,31,33,23,24,23,33,34,35,36,35,14,42,6,5,2,1,2},
	
	/*3号切换路线, 第2个宝物所在位置在37，并且第3个宝物位置在27所切换的路线*/
	{37,36,15,30,31,32,31,33,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},
	
	/*4号切换路线, 第2个宝物所在位置在47，并且第3个宝物位置在24所切换的路线*/
	{47,46,43,44,37,36,15,30,31,32,31,33,23,24,23,33,34,35,36,35,14,42,6,5,2,1,2},
		
	/*5号切换路线, 第2个宝物所在位置在47，并且第3个宝物位置在27所切换的路线*/
	{47,46,43,44,37,36,15,30,31,32,31,33,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},
};
...
const u8 runMethodTableTreasure[][100]={
	...
	/*2号切换路线, 第2个宝物所在位置在37，并且第3个宝物位置在24所切换的路线*/
	{37,36,15,30,31,32,31,33,23,24,23,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},
...
//		speedRec_Init(&glmotorSpeed,1300,1300);flMethod_DownPlatform
//rotAngle_Right(180);
	//	rotAngle_Left(180);
		//delay_ms(1000);
		
//			speedAdjustment(2000,2000);
	//	speedAdjustment(800,800);//	FL_slow
		//speedAdjustment(3350,3500);flMethod_default
		//speedAdjustment(2140,2300);	flMethod_NFL
		//speedAdjustment(6500,6480);flMethod_quickest
		//speedRec_Init(&glmotorSpeed,1500,1600);flMethod_16_44
	}
}
