...
const u16  brige_sensorThreshold[NUM_OF_SENSOR] = {800,800,850,1000,700,800,700,700,600,800,800,800};
...
const u8 runMethodTable[][100]={
	/* 调试路线 */
/*0*/{16,17,18,19,18,20,21,22,23,24/*5,12,7,6,5*/}, 
...
//new/*4*/{1,2,3,4,3,5,12,7,6,15,37,14,35,36,35,14,16,44,45,46,47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,49,15,31,32,31,9,5,2,1,2},
	/*4*/{1,2,3,4,3,5,12,7,6,15,37,14,35,36,35,14,16,44,45,46,47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,49,15,31,32,31,9,5,2,1,2},
...
///*5*/{1,2,3,4,3,5,10,11,10,12,7,6,42,14,44,43,17,18,19,18,17,43,16,44,45,46,47,46,43,44,37,36,15,30,31,32,31,33,23,24,23,25,26,27,26,25,33,34,35,36,35,14,42,6,5,2,1,2},	
	/*5*/{1,2,3,4,3,5,12,7,6,15,37,14,35,36,35,14,16,44,45,46,47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,49,15,31,32,31,9,5,2,1,2},
		
    /*过全部景点，不切路线 没更新路线,已改*/	
   /*6*/{1,2,3,4,3,5,12,10,11,10,6,8,6,7,6,15,37,14,35,36,35,14,16,44,45,46,47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,49,15,31,32,31,9,5,2,1,2},	

// /*6*/	{1,2,3,4,3,5,12,10,11,10,6,8,6,7,6,15,37,  14,16,44,45,46,47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,    23,22,21,20,18,17,14,  35,36,35,34,30,31,32,31,9,5,2,1,2},
		 

	 
	 // /*6*/	{1,2,3,4,3,5,12,10,11,10,6,8,6,7,6,15,37,   15,31,32,31,30,   34,35,36,35,14,16,44,45,46,47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,    23,22,21,20,18,17,14,6,5,2,1,2},
...
/*8*/{12,7,6,15,37,15,9,5,2,1,2},
	...
	/*2号切换路线, 第2个宝物所在位置在37，并且第3个宝物位置在24所切换的路线*/
///*9*/{37,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,23,22,21,20,18,17,49,16,44,45,46,47,46,48,43,16,44,14,35,36,35,34,30,31,32,31,9,5,2,1,2},
	{37,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,30,31,32,31,9,5,2,1,2},

	/*3号切换路线, 第2个宝物所在位置在37，并且第3个宝物位置在27所切换的路线*/
///*10*/{37,17,18,19,18,20,21,22,23,25,26,27,26,25,23,24,23,22,21,20,18,17,49,16,44,45,46,47,46,48,43,16,44,14,35,36,35,34,30,31,32,31,9,5,2,1,2},
	{37,15,31,32,31,30,50,27,25,26,27,26,25,23,24,23,22,21,20,18,19,18,17,14,6,5,2,1,2},
		
	/*4号切换路线, 第2个宝物所在位置在47，并且第3个宝物位置在24所切换的路线*/
///*11*/{47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,23,22,21,20,17,14,35,36,35,34,30,31,32,31,9,5,2,1,2},
	{47,46,48,43,16,17,18,19,18,20,21,22,23,24,23,25,26,27,26,25,28,50,30,31,32,31,9,5,2,1,2},
		
	/*5号切换路线, 第2个宝物所在位置在47，并且第3个宝物位置在27所切换的路线*/
///*12*/{47,46,48,43,16,17,18,19,18,20,21,22,23,25,26,27,26,25,23,24,23,22,21,20,17,14,35,36,35,34,30,31,32,31,9,5,2,1,2},
	{47,46,48,43,16,17,18,19,18,20,21,22,23,25,26,27,26,25,23,24,23,22,21,20,18,17,14,6,5,2,1,2},	
};
...
u8 RunMethod_Check=0;                   //检查你所选路线是跑到哪一个平台(用于寻宝切换路线) 
u8 QR_code[2];
u8 Treasure_code[3]={0,0,0};				//记录宝物
float angle_read;
float angle_read_back;
u8 Treasure_all_Flag = 0;              //不切路线的标志位
