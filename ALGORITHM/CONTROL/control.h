...
typedef enum { FL_default,FL_circular,FL_node,FL_43_44,FL_16_44,FL_angle,
	             FL_slow_angle,FL_middle,FL_brige,FL_brigeup,FL_brigedown,
	             FL_slow,FL_quick,FL_stop,FL_quickest,FL_upPeak,FL_downPeak,
               FL_UpPlatform,FL_DownPlatform,FL_left,FL_Right,NFL,NFL_slow,
...
typedef enum { SEEK_PESL,SEEK_PESR,SEEK3,SEEK4,SEEK_default,NOTSEEK,SEEK_SeeSaw,SEEK_SeeSaw_back,
           SEEK_PesPlatform,SEEK_Collision,SEEK_Collision_1,SEEK_7_6_15,SEEK_6_15_37,SEEK_digR,SEEK_digL,
           SEEK4_delay}seekNodeWay;

/*停车方法*/
typedef enum { NOTPARK,PARK1,PARK_pesR,PARK_pesR_time,PARK_pesR_50,PARK_pesR_100,
           PARK_default,PARK_pesL,PARK_pesL_time,PARK_PesPlatform,PARK_Door, 
...
typedef enum { HL_180,HL_145,HL_135,HL_130,HL_105,HL_120,HL_90,HL_60,HL_45,HL_35,HL_30,
            HN_Rotate,HR_35,HR_45,HR_60,HR_90,HR_110,HR_120,HR_130,HR_135,HR_145,HR_180,
