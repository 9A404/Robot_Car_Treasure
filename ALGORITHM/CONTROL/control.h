...
typedef enum {FL_default,FL_circular,FL_node,FL_43_44,FL_16_44,FL_angle,FL_slow_angle,FL_middle,FL_brige,FL_brigeup,FL_brigedown,FL_slow,FL_quick,FL_stop,
			  FL_quickest,FL_upPeak,FL_downPeak,FL_UpPlatform,FL_DownPlatform,FL_left,FL_Right,NFL,NFL_slow,BACK_NFL,FL_UPRISE,FL_DOWNRISE,FL_slowest,NFL_slowest}findLine;
...
typedef enum {FREE,BRIGE,DOOR,S_BOARD_1,S_BOARD_2,S_BOARD_26_27,SEESAW,GO_TILT_R,GO_TILT_L,
			...
			DOWNPLATFORM,ALL_TILT,DOWN27_26,ANGLE,ANGLE_BACK,STEP,HEIGHTLITM,STEP2,STEP_2,TUNNEL}typeRoadblock;	//无障碍、桥、门、减速带、跷跷板、倾斜路面、斜坡、平台景点、梯形景点、复杂节点定时                                                                                                                                  

	
/*加速类型*/
typedef enum {DOWN_SPEED,COMMON_SPEED,NOSPEED,TME,UPRISE,TUNNEL_SPEED,DOOR_SPEED}typeSpeed;//下台加速，普通加速，不加速，占时间（用于处理复杂节点)
...
/*停车方法*/
typedef enum {NOTPARK,PARK1,PARK_pesR,PARK_default,PARK_pesL,PARK_PesPlatform,PARK_Door,PARK_pesR_100,PARK_pesL_150,PARK_pesL_200,PARK_pesR_150,PARK_pesR_200,}carPark;

/*车头旋转角度*/
typedef enum {HL_180,HL_145,HL_135,HL_105,HL_120,HL_90,HL_60,HL_45,HL_35,HL_30,HN_Rotate,HR_35,HR_45,HR_60,HR_90,HR_110,HR_120,HR_130,HR_135,HR_145,HR_180,rot_LFL,rot_RFL,rot_UL,rot_UR,Sensor_L90,Sensor_R90}carRotAngle;
