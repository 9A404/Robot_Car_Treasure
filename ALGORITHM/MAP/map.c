...
/*2节点*/ {		{1,2,FL_slow,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_default,HR_180},
				...
				{4,3,FL_slow,BRIGE,COMMON_SPEED,30,SEEK_PesPlatform,PARK_PesPlatform,HN_Rotate},
				{5,3,FL_slow,S_BOARD_1,NOSPEED,0,SEEK_default,PARK_pesL,HL_60},},//2节点			
...
/*5节点*/ {		{2,1,FL_slow,S_BOARD_1,NOSPEED,0,SEEK_default,NOTPARK,HN_Rotate},
				...
				{12,7,FL_default,FREE,COMMON_SPEED,115,SEEK_PesPlatform,PARK_PesPlatform,HN_Rotate},
				...
				{3,4,FL_slow,STEP,NOSPEED,0,SEEK_default,NOTPARK,rot_LFL},},      

/*6节点*/ {		{7,6,FL_default,FREE,COMMON_SPEED,50,SEEK_PesPlatform,PARK_PesPlatform,HN_Rotate},
				{8,6,FL_slow,FREE,COMMON_SPEED,65,SEEK_Collision_1,NOTPARK,HR_180},
...
/*7节点*/ {		{6,5,FL_default,PLATFORM,COMMON_SPEED,50,SEEK_PESR, NOTPARK,HN_Rotate},
				...
				{6,15,FL_default,PLATFORM,COMMON_SPEED,40,SEEK_digR,NOTPARK,rot_RFL},},
						
/*8节点*/ {		{6,7,FL_slow,FREE,COMMON_SPEED,65,SEEK_default,PARK_pesR_200,HR_145},
...
/*10节点*/{		{12,10,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HN_Rotate},
				{11,10,FL_slow,FREE,COMMON_SPEED,38,SEEK_Collision_1,NOTPARK,HR_180},
				...
				{12,6,FL_default,FREE,COMMON_SPEED,10,SEEK_PesPlatform,PARK_PesPlatform,HN_Rotate},
				{6,8,FL_default,FREE,COMMON_SPEED,130,SEEK_default,NOTPARK,rot_RFL},
...
/*11节点*/{		{10,9,FL_default,FREE,NOSPEED,0,SEEK_default,NOTPARK,HR_35},
				{10,12,FL_slow,FREE,COMMON_SPEED,22,SEEK_default,PARK_pesL,HL_120},
				...
				{10,6,FL_slow,FREE,COMMON_SPEED,35,SEEK_PESL,NOTPARK,HR_35},},
...
/*14节点*/{		{15,9,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR,HL_90},
				...
				{16,44,FL_slow,ANGLE,COMMON_SPEED,20,SEEK_default,PARK_pesR,HR_130},},
...
/*15节点*/{		{9,5,FL_default,FREE,COMMON_SPEED,60,SEEK4,PARK_pesR,HL_90},
				...
				{14,35,FL_default,FREE,COMMON_SPEED,60,SEEK_default,PARK_pesR,HL_90},},
...
/*17节点*/{		{18,20,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},
				{18,19,FL_slow,FREE,NOSPEED,0,SEEK_default,PARK_pesL,HL_90},
				...
				{14,35,FL_default,FREE,COMMON_SPEED,75,SEEK4,PARK_pesR,HR_90},
				{16,44,FL_slow,ANGLE_BACK,NOSPEED,0,SEEK_PESL,PARK_default,HN_Rotate},},
							
/*18节点*/{		{20,21,FL_default,FREE,TUNNEL_SPEED,20,SEEK4,PARK_pesL,HL_90},
				{19,18,FL_slow,FREE,NOSPEED,0,SEEK_Collision,NOTPARK,HN_Rotate},
...
/*22节点*/{		{23,24,FL_default,FREE,COMMON_SPEED,20,SEEK_default,PARK_pesR_100,HR_130},
...
/*25节点*/{		{26,27,FL_slow,FREE,NOSPEED,0,SEEK_default,PARK_pesL,HL_90},
				...
				{28,50,FL_default,HEIGHTLITM,NOSPEED,0,SEEK_default,PARK_pesL,HL_90},},
...
/*26节点*/{		{27,26,FL_slow,S_BOARD_26_27,NOSPEED,0,NOTSEEK,PARK_PesPlatform,HN_Rotate},
				...
				{25,28,FL_default,FREE,NOSPEED,0,SEEK_default,PARK_pesR,HR_90},},
...
/*31节点*/{		{32,31,FL_slow,FREE,NOSPEED,0,SEEK_Collision,NOTPARK,HN_Rotate},
				...
				{15,14,FL_default,FREE,NOSPEED,0,SEEK_default,PARK_pesL,HL_90},},
							
/*32节点*/{		{31,33,BACK_NFL,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HL_90},
				{31,30,BACK_NFL,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HR_90},
				{31,9,BACK_NFL,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HR_90},
				{31,15,BACK_NFL,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HR_90},},
...
/*35节点*/{		{36,35,FL_slow,FREE,NOSPEED,0,SEEK_Collision,NOTPARK,HN_Rotate},
				...
				{6,5,FL_default,FREE,DOOR_SPEED,30,SEEK_default,PARK_pesL,HR_90},},
...
/*37节点*/{		{36,24,FL_default,PLATFORM,NOSPEED,0,SEEK4,PARK_pesR,HR_135},
				...
				{14,16,FL_default,PLATFORM,COMMON_SPEED,190,SEEK4,NOTPARK,HN_Rotate},
				...
				{17,18,FL_default,PLATFORM,COMMON_SPEED,325,SEEK_default,PARK_pesL,HL_90},},
...
/*43节点*/{		{44,14,FL_43_44,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HL_30},
				...
				{17,18,FL_slow,FREE,TME,30,SEEK_default,PARK_pesL,HL_90},
...
/*44节点*/{		{14,38,FL_default,FREE,NOSPEED,0,SEEK4,NOTPARK,HN_Rotate},
				...
				{14,35,FL_default,FREE,COMMON_SPEED,30,SEEK4,PARK_pesL,HR_90},},

/*45节点*/{		{46,47,FL_slow,FREE,TME,30,SEEK_default,PARK_pesL,HL_90},},
...
/*48节点*/{		{43,44,FL_slow,SEESAW,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate},
				...
				{43,17,FL_slow,SEESAW,TME,20,SEEK_default,PARK_pesR_150,HR_135},
...
/*50节点*/{		{30,31,FL_slow,STEP,NOSPEED,0,SEEK4,PARK_pesR,HR_90},
				{49,15,FL_default,FREE,COMMON_SPEED,15,SEEK4,PARK_pesR_150,HL_45},
				{28,25,FL_default,FREE,NOSPEED,0,SEEK_default,PARK_pesR,HR_90},}
};
