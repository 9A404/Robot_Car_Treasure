...
/*5节点*/	{	{2,1,FL_slow,S_BOARD_1,NOSPEED,0,SEEK_default,NOTPARK,HN_Rotate},
				...
				{12,7,FL_slow,FREE,COMMON_SPEED,105,SEEK_PesPlatform,PARK_PesPlatform,HN_Rotate},
...
/*12节点*/{		{10,9,FL_quick,PLATFORM,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},
				...
				{7,6,FL_default,PLATFORM,COMMON_SPEED,260,SEEK_PesPlatform,PARK_PesPlatform,HN_Rotate},
